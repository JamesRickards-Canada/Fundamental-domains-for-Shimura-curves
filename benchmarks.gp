...
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 753.98223686155037723103441198708069220;

A=alginit(F, [14820, -343]);\\Ramified at 3, 5, 13, 19
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 1809.5573684677209053544825887689936613

A=alginit(F, [67, 61]);\\Ramified at 63, 67
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 4146.9023027385270747706892659289438071

A=alginit(F, [7975922955, -39733]);\\Ramified at 2, 3, 5, 7, 11, 13
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 6031.8578948924030178482752958966455376

A=alginit(F, [103, 101]);\\Ramified at 101, 103
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 10681.415022205297010772987503150309806

A=alginit(F, [3, 1]);\\Unramified
Or=algorderalgtomatrix(A, [[1, 0]~, [900*x, 0]~, [468*x + 1/2, 1/2]~, [2375/6*x + 1/2, 1/6*x + 1/2]~]);\\Level 900
X=afuchinit(A, Or);
avgtime(fil, X, tno, testspercase);tno++;\\area 2261.9467105846511316931032359612420766

A=alginit(F, [11, -3]);\\Ramified at 3, 11
Or=algorderalgtomatrix(A, [[1, 0]~, [115*x, 0]~, [197/2*x, 1/2]~, [63/2*x + 1/2, 1/2*x + 1/2]~]);\\Level 115
X=afuchinit(A, Or);
avgtime(fil, X, tno, testspercase);tno++;\\area 3015.9289474462015089241376479483227688

A=alginit(F, [31, 29]);\\Ramified at 29, 31
Or=algorderalgtomatrix(A, [[1, 0]~, [x, 0]~, [5/2*x, 5/2]~, [2*x + 1/2, 1/2*x + 2]~]);\\Level 5
X=afuchinit(A, Or);
avgtime(fil, X, tno, testspercase);tno++;\\area 5277.8756580308526406172408839095648454
...
X=afuchinit(A, Or);
avgtime(fil, X, tno, testspercase);tno++;\\area 3485.0734503822772992012257265180618662

F=nfinit(y^2-11);
A=alginit(F, [7*y-12, -5]);\\ramified above 79
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 571.76986295334236940020109575686952492;
...
X=afuchinit(A, Or);
avgtime(fil, X, tno, testspercase);tno++;\\area 4071.5040790523720370475858247302357379

F=nfinit(y^2-122);
A=alginit(F, [-y - 1, -3]);\\Ramified at 3.
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 1935.2210746113126348929883241001737767
...
X=afuchinit(A, Or);
avgtime(fil, X, tno, testspercase);tno++;\\area 452.38934211693022633862064719224841532

F=nfinit(y^3-y^2-4*y+3);
A=alginit(F, [580*y^2 + 656*y - 2851, -16*y^2 - 16*y + 7]);\\Ramified at 3, 47
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 770.73739768069594116950184336457137425
...
X=afuchinit(A, Or);
avgtime(fil, X, tno, testspercase);tno++;\\area 2513.2741228718345907701147066236023074

F=nfinit(y^3-y^2-2*y+1);
A=alginit(F, [2*y^2 - 7*y - 7, -39*y^2 + 67*y - 49]);\\Ramified at primes above 13, 757
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 1357.1680263507906790158619415767452460


F=nfinit(y^4+2*y^3-4*y^2-6*y+1);
A=alginit(F, [-92*y^3 - 172*y^2 + 352*y + 221, 2*y^3 + 4*y^2 - 7*y - 18]);
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 469.14450293607579027708807856973909737;
...
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 309.97047515419293286164748048357761790
\p38
...
X=afuchinit(A);
avgtime(fil, X, tno, testspercase);tno++;\\area 138.23007675794148146897200035709829535
