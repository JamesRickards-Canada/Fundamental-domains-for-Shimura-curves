...
/*SECTION 3: QUATERNION ALGEBRA METHODS*/
  ...
  install(afuchchangep,"GG");
  addhelp(afuchchangep,"afuchchangep(X, p): returns the Fuchsian group with the changed the value of p, i.e. what is sent to 0 under the map from the upper half plane to the unit disc/Klein model. We also recompute the fundamental domain and presentation if they were initialized.");
